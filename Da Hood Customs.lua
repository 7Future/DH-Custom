...
sec:Button("ChatBypasser", function()
...
sec:Button("UnfocusedWindowOptimization", function()
...
sec:Button("FreeAnimations", function()
...
sec:Button("NoSlowDown", function()
...
sec:Button("NoJumpCooldown", function()
...
sec:Button("InfStamina", function()
...
sec:Button("AdminBase[🕵️🎖️]", function()
...
sec:Button("PlayGround[⛱️🤾🏼‍♀️]", function()
...
sec:Button("PoliceStation/Jail[👮🏻🚓]", function()
...
sec:Button("Gunshop#1[🔫🛍️]", function()
...
sec:Button("FoodStore#1[🍲🏬]", function()
...
sec:Button("FoodStore#2[🍲🏪]", function()
...
sec:Button("GasStation[⛽🛢️]", function()
...
sec:Button("SkatePark[🏞️⛸️]", function()
