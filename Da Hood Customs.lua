...
local sec4 = tab:Section("[UPDATED]")

sec4:Button("Bank[Inside][🏦💵]", function()
...
sec4:Button("AdminBase[🕵️🎖️]", function()
...
sec4:Button("PlayGround[⛱️🤾🏼‍♀️]", function()
...
sec4:Button("PoliceStation/Jail[👮🏻🚓]", function()
...
sec4:Button("Gunshop#1[🔫🛍️]", function()
...
sec4:Button("Gunshop#2[🔫🛒]", function()
...
sec4:Button("FoodStore#1[🍲🏬]", function()
...
sec4:Button("FoodStore#2[🍲🏪]", function()
...
sec4:Button("GasStation[⛽🛢️]", function()
...
sec4:Button("SkatePark[🏞️⛸️]", function()
